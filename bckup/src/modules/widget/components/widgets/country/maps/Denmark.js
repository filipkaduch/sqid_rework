...
(function(root, factory) {
	...
	}echarts.registerMap('丹麦', {type: 'FeatureCollection',
		features: [
			{type: 'Feature',
			...
			{type: 'Feature',
				...
				geometry: {type: 'Polygon',
					coordinates: ['@@FNn@nXBX~`XAJLGZN^CTSNWlOSICUkYVGSOMQZYkNkDGEcCOF_@RVVZP'],
					encodeOffsets: [
						[
							12525,
							57187
			...
			{type: 'Feature',
				...
				geometry: {type: 'Polygon',
					coordinates: ['@@ÀS\\FHJ\\EAM\\kdUBU_BSGWBAQVWBeP@`TDCP]CSTeBgICTPFbCRL'],
					encodeOffsets: [
						[
							12596,
							57102
			...
			{type: 'Feature',
				...
				geometry: {type: 'Polygon',
					coordinates: ['@@HP^JA^RVEzDHIb@^TtXbf^`tKPZRrObShs¨_POY`MrLPGXcgZAhY\\I~M`KhBNEVcOEIODQXiKQ[MBU[G@K]OFMRMEWUIiceGsNoBÅVkRS@kPYP¡XQCZiA`STcHaR@TYI'],
					encodeOffsets: [
						[
							15034,
							56418
			...
			{type: 'Feature',
				...
				geometry: {type: 'Polygon',
					coordinates: ['@@DTRBL\\TXMRTH^CjJ`QfTQ`@PEdDHFlClMNEDOIMuCZKQS[DAONOQKaDOEDShJfATS^DDOSC@_fOMQO@aM»^QLYFQPWLfRQPYH[I_DeAORUBuVGN'],
					encodeOffsets: [
						[
							12400,
							57114
			...
			{type: 'Feature',
				...
				geometry: {type: 'Polygon',
					coordinates: ['@@XZhEbO¤F@kbHRIXFXIdAPGM[]i@MS_LMWO¡MEGoD[O[DWGST]DlXqbGZUDSNbJI^TFA\\Vb'],
					encodeOffsets: [
						[
							12675,
							57346
			...
			{type: 'Feature',
				...
				geometry: {type: 'Polygon',
					coordinates: ['@@YZRPNHTUFOpINS[_HKEgtBkMAaU@WJ[FGI[E¿TMPBP\\CRTYLvDJNCPMF'],
					encodeOffsets: [
						[
							12623,
							57152
			...
			{type: 'Feature',
				...
				geometry: {type: 'Polygon',
					coordinates: ['@@hTf^J²n¦nxJPPMvEz_XGjAPEOeHKYQKJGWOBIWYDA@FIWSMFcC]JWCIW[CMKwGHD^uRWLoQAL]JBhP'],
					encodeOffsets: [
						[
							12297,
							57376
			...
			{type: 'Feature',
				...
				geometry: {type: 'Polygon',
					coordinates: ['@@OAg^IBKpRXKvQC]cYYCSQBYMETUdAPMDQyUo_QLS^D^SbadEV]BMNOC]D{UKIkEyMWFo@GVMNRZ~TX\\lL^'],
					encodeOffsets: [
						[
							12297,
							57376
			...
			{type: 'Feature',
				...
				geometry: {type: 'Polygon',
					coordinates: ['@@xEXDGYix[NAFWME[c]K]QcgOHcBWJWEQJaG@l£EaPgFAJXPIHLZRGLPf'],
					encodeOffsets: [
						[
							12716,
							57443
			...
			{type: 'Feature',
				...
				geometry: {type: 'Polygon',
					coordinates: ['@@GxHNL\\DJXXD^IdDNEXTEJ@BCUaB[SEJ]aITMVCHYrakWYMKHIWB}_AWmWm@EMoBMjqXYAQKKOJKT_JKRzVCRONcBSVNFAZTRZDdZ'],
					encodeOffsets: [
						[
							12417,
							57316
			...
			{type: 'Feature',
				...
				geometry: {type: 'Polygon',
					coordinates: ['@@lZDVTJ^ChDTNfDRCDSZBpGvBZgD}JI[BKEGMD[GyCMHeEo@[GGL\\`MToJEP'],
					encodeOffsets: [
						[
							12691,
							57180
