...
(function(root, factory) {
	...
	}echarts.registerMap('荷兰', {type: 'FeatureCollection',
		features: [
			{type: 'Feature',
				properties: {name: 'Aruba'},
				geometry: {type: 'Polygon',
					coordinates: ['@@NQZIfY@GHALFNKLOLCAE\\aNENOLQREHKFUJ_HOBUFUFEQKI@OPWFEFOLQAE@GJBDIFI@WHQLYXA@_\\UJIBAFQH@HYRMDALGJIDILOHKNAFIFAFRZ@NLLFNDLCREPI^KLLNPGDGl[FGJSXWPO'],
					encodeOffsets: [
						[
							-71675,
							12871
