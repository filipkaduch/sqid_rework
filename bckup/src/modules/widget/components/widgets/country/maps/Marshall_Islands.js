...
(function(root, factory) {
	...
	}echarts.registerMap('马绍尔群岛', {type: 'FeatureCollection',
		features: [
			{type: 'Feature',
			...
			{type: 'Feature',
				...
				geometry: {type: 'Polygon',
					coordinates: ['@@FHbPpPfTbfrVXldBvDdNzZ~lhllfffPvPtJdBvAOxS|_`Whc^_h{lb¡HiJDÃAcNJ}DyA}EcO}I[WqUaW_kke]gcMO]CwAcBNmPuBLkPoV[Pg^uvQX»ĢQE'],
					encodeOffsets: [
						[
							173727,
							10541
			...
			{type: 'Feature',
				...
				geometry: {type: 'Polygon',
					coordinates: ['@@FHfNp^~hx\\^jbzf|XnLHxA^COhOt[zmhiduTgRqJiFCqK}[͛È@t'],
					encodeOffsets: [
						[
							172823,
							7938
			...
			{type: 'Feature',
				properties: {name: 'Lae'},
				geometry: {type: 'Polygon',
					coordinates: ['@@HJjNdVnj|ddXTh^brR^HtHrBG|OehW|ibaZ[tXgVuLgJAyKWO_eu]aogm][MWOCB]DsL}Vo\\]Tid]bi~Y~OzEhC®'],
					encodeOffsets: [
						[
							169998,
							9173
