...
(function(root, factory) {
	...
	}echarts.registerMap('圣赫勒拿-阿森松和特里斯坦-达库尼亚', {type: 'FeatureCollection',
		features: [
			{type: 'Feature',
				properties: {name: 'Ascension'},
				geometry: {type: 'Polygon',
					coordinates: ['@@FLVNHXCHFHVTPCFJRANKJBRIAEVURDFIPKJYVGFGJ@HICKKCGHGAEYKGGBaQKKQHUKSBMGOAKEMFONKRJPGTGLCR@N'],
					encodeOffsets: [
						[
							-14766,
							-8125
			...
			{type: 'Feature',
				...
				geometry: {type: 'Polygon',
					coordinates: ['@@NPR\\NJDVJT^RNDTVVJPJAJJFDJLDDGTKRBJENJTAJQCIHICIFIN@BIJEGUF_O@KEAMKIM@WYQAKGWJMAOMUGOIQOOFINANIHWBCHYH'],
					encodeOffsets: [
						[
							-5928,
							-16380
