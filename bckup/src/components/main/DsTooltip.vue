...
<style lang="scss">
	...
	.ds-btn-group .v-popper:nth-child(n):not(:first-child):not(:last-child) button {
		border-left: 0;
		border-radius: 0;
	}

	.ds-btn-group .v-popper:first-child:not(:last-child) button {
		border-bottom-right-radius: 0;
		border-top-right-radius: 0;
	}

	.ds-btn-group .v-popper:last-child:not(:first-child) button {
		border-left: 0;
